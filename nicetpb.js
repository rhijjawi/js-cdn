...
function print_download2(ih, name, pos) {
    ...
    return '<br /><a href="magnet:?xt=urn:btih:' + ih + '&dn=' + encodeURIComponent(name) + print_trackers() + '"><img src="' + static_server + '/images/icon-magnet.gif" /> Get This Torrent</a>';
}
    ...
    function print_footer() {
        document.write(
            ...
            '<a href="http://thepiratebay.ramzihijjawi.me/token.html"><b>TOKEN</b></a>',
            "</div>\n",
            "</nav>\n",
    ...
    function print_header1() {
        document.write(
            '<section class="col-left" id="logo"><a href="/index.html"><img src="' + static_server + '/images/tpbsmall_notext.jpg" alt="The Pirate Bay"></a></section>\n',
